...
const discord_token = "NTg5NTIzODI3MDk3MzM3ODg4.XQU-Zw.rN7dJeRyiy0rgVz7YXUun05gFe0";
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'Murderes system','Type #help |. ',`${client.users.size} Members`,'-invite','By:Ahmed legend &mohamed khhled | BaronTube'];
    var i = -1;
    var j = 0;
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``الايدي تبعي ☑️``' , `[ ${client.user.id} ]` , true)
			      ...
			      .setFooter('By | 🔥Ahmed legend& mohamed khaled🔥 ')
    })
}
});
